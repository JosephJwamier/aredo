# Generated by Django 5.2.3 on 2025-08-05 11:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(help_text='Unique identifier for the form type', max_length=30, unique=True)),
                ('name', models.CharField(help_text='Display name for the form type', max_length=100)),
                ('description', models.TextField(blank=True, help_text='Detailed description of what this form type is for')),
                ...
                ('display_order', models.PositiveIntegerField(default=0, help_text='Order in which to display this form type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_type', models.CharField(choices=[('passport', 'Passport'), ('certificate', 'Certificate'), ('transcript', 'Transcript'), ('id_document', 'ID Document'), ('supporting_doc', 'Supporting Document'), ('other', 'Other')], default='other', help_text='Type of document in the image', max_length=20)),
