# Generated by Django 5.2.3 on 2025-09-02 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='Main news content', max_length=5000)),
                ('excerpt', models.CharField(blank=True, help_text='Brief summary for previews', max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_type', models.CharField(choices=[('gallery', 'Gallery'), ('inline', 'Inline'), ('thumbnail', 'Thumbnail'), ('banner', 'Banner'), ('infographic', 'Infographic'), ('other', 'Other')], default='gallery', max_length=20)),
        ...
        migrations.AddField(
            model_name='news',
            name='news_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='news_articles', to='aredoapp.newstype'),
        ),
        migrations.CreateModel(
            name='University',
            fields=[
        ...
        migrations.AddIndex(
            model_name='news',
            index=models.Index(fields=['status', 'published_at'], name='aredoapp_ne_status_cc49e3_idx'),
        ),
        migrations.AddIndex(
            model_name='news',
            index=models.Index(fields=['news_type', 'is_featured'], name='aredoapp_ne_news_ty_e8be6f_idx'),
        ),
        migrations.AddIndex(
            model_name='news',
            index=models.Index(fields=['slug'], name='aredoapp_ne_slug_18aaee_idx'),
        ),
        migrations.AddIndex(
            model_name='applicationform',
